...
- `docs/` — Architecture diagrams, dbt docs site, Snowflake benchmark captures
  - [dbt docs site - auto-generated by GitHub Action on push](https://mikesparr.github.io/1000-genomes-dwh/#!/overview)
...
# if error: sqlfluff fix analyses/   (i had to manually fix q02)
